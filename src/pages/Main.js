            ...
            <button type="button" className="go_top btnScrollToTop">
                ...
                <div className="home-banner">
                    <div className="home-banner-container">
                        ...
                        <div className="banner-content">
                            ...
                            <p>
                                책을 읽고 난 후의 느낀점 혹은 생각을 솔직하게 남겨보세요
                            </p>
                ...
                <div className="center">
                    <div className="content"> <img src={imgCategory1} alt=""/>
                        <Btn2 to="/board" bgColor="#333">자유롭게 전하는 독서 감상문</Btn2>
                    </div>
                    <div className="content"> <img src={imgCategory2} alt=""/>
                        <Btn2 to="/board" bgColor="#333">기록으로 남겨보세요</Btn2>
                    </div>
                    <div className="content"> <img src={imgCategory3} alt=""/>
                        <Btn2 to="/board" bgColor="#333">유저들과 의견을 공유해보세요</Btn2>
                    </div>
                </div>
                <div className="center">
                    <MainStyled.Card className="card-wrap">
                        <div className="card-center">
                            ...
                            <div className="card-desc"><p>그저, 좋은 글들만 가득한 책들이 줄 수 없는 개인의
이야기까지 담겨 있는 자전적 에세이 형식의 책을 읽노라면,
...
다시 힘을 내게 됩니다</p></div>
                    ...
                    <MainStyled.Card className="card-wrap">
                        <div className="card-center">
                            ...
                            <div className="card-desc"><p>이 세상엔 참 많은 사랑이 있다. 사랑이 서로에게 불가능하다고 느껴지는 사람들. 그런 남녀들에게도 사랑은 찾아오나 보다. 이 책은 기다림과 아픔 끝에 찾아오는 사랑에 대해서 말하고 있었다.</p></div>
                            <div className="card-discuss">
                            <FontAwesomeIcon icon={faMessage} flip="horizontal" style={{ color: "#000000" }} />
                            <span>&nbsp; 화제의 도서</span>
                        </div>
                        ...
                        <div className="card-book">
                            <div className="card-book_title"><span><strong>Currently reading</strong></span></div>
                            <div className="card-book_img"><img src={cardBook2} alt="프로필" /></div>
                        </div>
                    </MainStyled.Card>
                    <MainStyled.Card className="card-wrap">
                        <div className="card-center">
                            ...
                            <div className="card-desc"><p>인생의 지혜, 충분한 건강과 휴식, 인간관계 등이 중요함을 우리도 알지만 일상에서는 귀찮다는 핑계로 무심코 넘겨 버리는 이런 요소들을, 꼼꼼하게 되짚고 그 순간에 최선을 다할 것을 저자는 우리에게 가르쳐 주고 있습니다.</p></div>
                            <div className="card-discuss">
                            <FontAwesomeIcon icon={faMessage} flip="horizontal" style={{ color: "#000000" }} />
                            <span>&nbsp; 화제의 도서</span>
                        </div>
                        ...
                        <div className="card-book">
                            <div className="card-book_title"><span><strong>Currently reading</strong></span></div>
                            <div className="card-book_img"><img src={cardBook3} alt="프로필" /></div>
                        </div>
                    </MainStyled.Card>
                </div>
